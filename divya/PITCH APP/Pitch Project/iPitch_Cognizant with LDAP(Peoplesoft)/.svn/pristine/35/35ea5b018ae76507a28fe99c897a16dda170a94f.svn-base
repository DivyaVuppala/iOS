...
@interface SSimpleCalculator ()

@end

@implementation SSimpleCalculator
...
- (void)viewDidUnload
{
    [self setCalculatorCopyButton:nil];
    [self setCalculatorDoneButton:nil];
    [super viewDidUnload];
...
- (IBAction)numberButtonPressed:(id)sender
{
    ...
    mainLabel.text = [mainLabelString stringByAppendingString:numString];
}
...
- (IBAction)calculatorCopyButton:(id)sender {
    ...
    pasteboard.string = mainLabel.text;
}
