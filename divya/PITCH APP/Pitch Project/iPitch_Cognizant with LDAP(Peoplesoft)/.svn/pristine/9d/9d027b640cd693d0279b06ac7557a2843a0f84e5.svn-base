...
NSString* kGTMRegexErrorDomain _INITIALIZE_AS(@"com.google.mactoolbox.RegexDomain");
...
//_EXTERN
NSString* kGTMRegexPatternErrorPattern _INITIALIZE_AS(@"pattern");
//_EXTERN 
NSString* kGTMRegexPatternErrorErrorString _INITIALIZE_AS(@"patternError");
