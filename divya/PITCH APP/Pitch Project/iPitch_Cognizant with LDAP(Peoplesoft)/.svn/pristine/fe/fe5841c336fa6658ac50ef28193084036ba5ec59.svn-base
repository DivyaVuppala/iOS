...
-(void) renderCalendarViewForPhone
{
    ...
    for(int i = 0; i < dayTitles.count; i++) {
        ...
        [((NSString *)[dayTitles objectAtIndex:i]) drawInRect: dayHeaderFrame withFont: [UIFont fontWithName: FONT_REGULAR size: 12] lineBreakMode: UILineBreakModeWordWrap alignment: UITextAlignmentCenter];
        CGContextRestoreGState(context);
    }
    ...
    [[UIColor whiteColor] setFill];
    [monthTitle drawInRect: textFrame withFont: [UIFont fontWithName:FONT_BOLD size: 16] lineBreakMode: UILineBreakModeWordWrap alignment: UITextAlignmentCenter];
    CGContextRestoreGState(context);
...
-(void) renderCalendarViewForPad
{
    ...
    //// Color Declarations
    UIColor* bigBoxInnerShadowColor = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 0.56];
    UIColor* backgroundLightColor = [UIColor colorWithWhite:0.1 alpha:0.1];
    
    UIColor* lineLightColor = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 0.27];
    
    //two colors for gradient bg.
    UIColor* lightColor = [UIColor colorWithWhite:0.1 alpha:0.1];
    UIColor* darkColor = [UIColor colorWithWhite:0.1 alpha:0.1];
    //outside shadow
    UIColor* boxStroke = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.59];
    ...
    for(int i = 0; i < dayTitles.count; i++) {
        ...
        [[UIColor whiteColor] setFill];
        [((NSString *)[dayTitles objectAtIndex:i]) drawInRect: dayHeaderFrame withFont: [UIFont fontWithName: FONT_REGULAR size: 14] lineBreakMode: UILineBreakModeWordWrap alignment: UITextAlignmentCenter];
        CGContextRestoreGState(context);
    }
