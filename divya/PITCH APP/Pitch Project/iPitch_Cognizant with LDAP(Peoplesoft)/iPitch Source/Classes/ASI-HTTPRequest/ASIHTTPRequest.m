...
- (id)initWithURL:(NSURL *)newURL
{
	...
	//[self setValidatesSecureCertificate:YES]; //Commented to bypass SSL certificate validation for Corporate Network
...
- (void)startRequest
{
    ...
    //Commented for SSL Certificate Issue with Corporate Network
    ...
    //Added for SSL Certificate Issue with Corporate Network
